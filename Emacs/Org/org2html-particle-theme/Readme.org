...
#+AUTHOR: revolt
#+DATE: <2025-11-13 Thu 22:59>

* 🚀 快速开始 - 5分钟搞定

#+BEGIN_QUOTE
*别慌！* 这可能是你见过最简单的 Org Mode 主题配置。我们的目标是让你在 5 分钟内拥有一个炫酷的知识库网站。\\
If 快速体验，可在 org mode 顶部添加该远程资源 =#+SETUPFILE: https://lovemoganna.github.io/DotFiles/Emacs/Org/org2html-particle-theme/theme-setup.org= 。\\
If 自行 Hack，可按下 =Alt-j= 跟着操作。
#+END_QUOTE
...
#+BEGIN_SRC bash
# 克隆仓库（或者直接下载zip）
git clone https://github.com/lovemoganna/org2html-particle-theme.git
...
* 📮 联系我们
- GitHub: [[https://github.com/lovemoganna/org2html-particle-theme]]
